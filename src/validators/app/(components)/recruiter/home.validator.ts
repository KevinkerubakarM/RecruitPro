...
const jobFiltersSchema = z.object({
    search: z.string().max(200, "Search query too long").optional().default(""),
    jobType: z.enum(["", "FULL_TIME", "PART_TIME", "CONTRACT", "INTERNSHIP", "REMOTE"]).optional().default(""),
    experienceLevel: z.enum(["", "ENTRY_LEVEL", "JUNIOR", "MID_LEVEL", "SENIOR", "LEAD", "EXECUTIVE"]).optional().default(""),
